...
# print the sum together with the euro symbol 
# checked stackoverflow to format for 3 decimal places -  https://stackoverflow.com/questions/14540143/python-3-float-decimal-points-precision
